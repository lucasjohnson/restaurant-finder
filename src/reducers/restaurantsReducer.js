...
export default function restaurantsReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case actions.GET_RESTAURANTS_SUCCESS:
      return { ...state, restaurants: action.payload, loading: false, searchSubmitted: true, refineSubmitted: false }
    ...
    case actions.REFINE_RESTAURANTS_RESULTS:
      return { restaurants: action.payload, loading: false, hasErrors: false, searchSubmitted: true, refineSubmitted: true }
    default:
      return state
  }
}
